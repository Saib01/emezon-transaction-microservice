package com.emazon.transaction.infraestructure.documentation;
...
public class OpenApiConfiguration {
    private static final String TITTLE = "Hexagonal Monolithic MicroserviceTransaction API";
    private static final String VERSION = "1.0";
    private static final String DESCRIPTION = "MicroService Transaction";
